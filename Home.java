...
public class Home extends JFrame implements ActionListener{
	...
	public static void main(String[] args) {
        ...
        public Home() {
            ...
            mnNew.setFont(new Font("Trebuchet MS", Font.BOLD, 17));


            JMenuItem AddAdmin = new JMenuItem("Add Admin");
            AddAdmin.addActionListener(this);
            AddAdmin.setBackground(new Color(211, 211, 211));
            AddAdmin.setForeground(new Color(105, 105, 105));
            mnNew.add(AddAdmin);
