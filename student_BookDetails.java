...
public class student_BookDetails extends JFrame implements ActionListener{
	...
	panel.setBorder(new TitledBorder(new LineBorder(new Color(95, 158, 160), 3, true), "Book-Details",
    ...
    public void actionPerformed(ActionEvent ae){
        try{
            ...
            conn con = new conn();
            if( ae.getSource() == b1){
                String sql = "select * from book where concat(name, label_id) like ?";
		PreparedStatement st = con.c.prepareStatement(sql);
