...
public class Statistics extends JFrame{
	...
	scrollPane.setBounds(40, 51, 1060, 220);
	...
	panel.setForeground(new Color(0, 128, 150));
	panel.setBounds(26, 36, 1100, 250);
	...
	ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("library/management/system/icons/tenth.png"));
        ...
        l1.setIcon(i3);
	l1.setBounds(950, 13, 150, 27);
	contentPane.add(l1);

	JScrollPane scrollPane_1 = new JScrollPane();
	scrollPane_1.setBounds(40, 326, 1060, 230);
	...
	panel_1.setBounds(22, 299, 1100, 270);
