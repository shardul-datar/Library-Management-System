...
public class Signup extends JFrame implements ActionListener{
	...
	contentPane.add(lblPassword);
        ...
        checkbox.setBounds(420,160,150,26);
    ...
    public void actionPerformed(ActionEvent ae){
        try{
            ...
            if(ae.getSource() == b1){
                String sql = "insert into student_account(username, name, password, sec_q, sec_ans) values(?, ?, ?, ?, ?)";
